    ...
    <div className="relative isolate overflow-hidden bg-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-24  sm:pb-32 lg:flex lg:px-8">
        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">Nyaya Kutira is started by Advocate Ramachandra Shenoy, who basically hails from Udupi District, Karnataka State. Who have vast experience in Criminal Law along with other fields of Law for more than decades. 

Nyaya Kutira is founded with intention to serve the litigants with highest level pf professionalism and integrity and it literally aims to help the litigants on priority basis by providing   reliable and highly effective legal service with cost cutting method.

“Nyaya- Justice & Kutira- House”  it simply means, it is a “HOUSE” for those who are facing legal battles, can find a solution under one roof without any second thought.
        ...
        <div className="mx-auto max-w-md mt-30 flex sm:mt-40 lg:ml-20 lg:mr-0 md:ml-82 xl:ml-32">
          <div className="max-w-md flex-none sm:max-w-2xl  lg:max-w-none">
            <Image src="/i2.jpg" alt="App screenshot" width="900" height="900" className="w-[30rem] rounded-md" />
          </div>
